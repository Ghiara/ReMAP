...
Examples:
  ...
  bash ReMAP/train/run_training.sh baseline-all
USAGE
}
...
run_python() {
  local script_path="$1"
  shift
  local extra_pythonpath="$REPO_ROOT:$REPO_ROOT/third_party/Meta_RL:$REPO_ROOT/third_party/Meta_RL/submodules/rlkit:$REPO_ROOT/third_party/Meta_RL/submodules/meta-environments-main:$REPO_ROOT/third_party/Meta_RL/submodules/MRL-analysis-tools-main"
