...
from ReMAP.scripts.vis_logging import log_all, _frames_to_gif
import torch
import cv2
...
def load_config(env_name):
    if env_name == "cheetah":
        ...
        from ReMAP.configs.half_cheetah_multi import config
    elif env_name == "hopper":
        from ReMAP.configs.hopper_multi import config
    elif env_name == "walker2d":
        from ReMAP.configs.walker_multi import config
    elif env_name == "ant":
        from ReMAP.configs.ant_multi import config
    else:
