...
def plot_velocity_tracking_curves(vel_results, save_dir):
    ...
    ax.set_title('RL2 - Velocity Tracking (cheetah-multi-task)', fontsize=13, fontweight='bold')
...
def plot_goal_tracking_curves(goal_results, save_dir):
    ...
    ax.set_title('RL2 - Goal Position Tracking (cheetah-multi-task)', fontsize=13, fontweight='bold')
    ax.legend(fontsize=9, loc='best', ncol=2)
    ax.grid(True, alpha=0.3)
    fig.tight_layout()
