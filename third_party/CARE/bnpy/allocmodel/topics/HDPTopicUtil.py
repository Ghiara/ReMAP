...
from third_party.CARE.bnpy.allocmodel.topics.OptimizerRhoOmegaBetter import kvec
from third_party.CARE.bnpy.util import NumericUtil
from third_party.CARE.bnpy.util import digamma, gammaln
from third_party.CARE.bnpy.util.StickBreakUtil import rho2beta
from third_party.CARE.bnpy.util.NumericUtil import calcRlogRdotv_allpairs
from third_party.CARE.bnpy.util.NumericUtil import calcRlogRdotv_specificpairs
from third_party.CARE.bnpy.util.NumericUtil import calcRlogR_allpairs, calcRlogR_specificpairs
from third_party.CARE.bnpy.util.NumericUtil import calcRlogR, calcRlogRdotv
from third_party.CARE.bnpy.util.SparseRespStatsUtil import calcSparseRlogR, calcSparseRlogRdotv
from third_party.CARE.bnpy.util.SparseRespStatsUtil \
