...
from third_party.CARE.bnpy.ioutil.ModelWriter import makePrefixForLap
from third_party.CARE.bnpy.allocmodel import AllocModelConstructorsByName
from third_party.CARE.bnpy.obsmodel import ObsModelConstructorsByName
from third_party.CARE.bnpy.util import toCArray, as1D, as2D
...
def load_model_at_prefix(matfilepath, prefix='Best', lap=None):
    ...
    import third_party.CARE.bnpy.HModel as HModel
