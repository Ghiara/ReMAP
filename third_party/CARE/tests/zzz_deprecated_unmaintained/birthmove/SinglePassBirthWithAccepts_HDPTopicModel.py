...
from third_party.CARE.bnpy.viz.PlotUtil import ConfigPylabDefaults
from third_party.CARE.bnpy.viz.PrintTopics import printTopWordsFromWordCounts
from third_party.CARE.bnpy.viz.PrintTopics import plotCompsFromWordCounts, uidsAndCounts2strlist
...
def main(**kwargs):
    ...
    # Final phase: merges
    from third_party.CARE.bnpy.mergemove import MergePlanner, MergeMove
