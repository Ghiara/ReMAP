...
from third_party.Meta_RL.smrl.vae.encoder_networks import MlpEncoder, GRUEncoder, SelfAttentionEncoder
from third_party.Meta_RL.smrl.data_management.replay_buffers import MultiTaskReplayBuffer
from third_party.Meta_RL.smrl.vae.decoder_networks import SeparateMlpDecoder
from third_party.Meta_RL.smrl.vae.mdpvae import NeuralProcess, MdpVAE
...
experiment3 = dict(
    description = {
        'name': 'Encoder-experiment-3',
        'file': __file__,
        'variant': "AttentionEncoder"
    },
    encoder_type = SelfAttentionEncoder,
    encoder_kwargs = dict(
        hidden_size=32,
        num_layers=4,
        encoding_mode='sample',
