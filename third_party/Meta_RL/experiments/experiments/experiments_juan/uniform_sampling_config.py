...
from third_party.Meta_RL.smrl.policies.exploration import RandomPolicy, RandomMemoryPolicy, MultiRandomMemoryPolicy, UniformPolicy
...
config = OrderedDict(
    ...
    inference_policy_type = UniformPolicy,    # Exploration policy for off-policy inference training (None -> on-policy training)
