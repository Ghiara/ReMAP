...
from ..vae.mdpvae import MdpEncoder
from ..policies.base import MetaRLPolicy
from ..environments import MetaEnv

SAVE_REWARD_PLOTS = False
...
def rollout_with_encoder(encoder: MdpEncoder, context_size: int):
    ...
    def rollout_fn(
        ...
        return _rollout_with_encoder(
            ...
            get_action_kwargs, full_o_postprocess_func,
            reset_callback
        )
    return rollout_fn
...
def _rollout_with_encoder(
    ...
    """Rollout function for Meta Reinforcement Learning. 
