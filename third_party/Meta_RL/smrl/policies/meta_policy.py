...
import sys
sys.path.insert(0, "/home/ubuntu/yuanmeng/MRL-Inference-Reutilization/submodules/Meta_RL/submodules/rlkit/")
#previous line points out the correct file with function "Delta"
...
from rlkit.torch.distributions import TanhNormal, Delta
