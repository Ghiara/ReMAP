...
EXPERIMENT_NAME  = "cheetah_velocity_single_low_level(forward_vel)"   # ⚠️ 改成你训练 velocity 的实验名
EPOCH            = 400
OUT_VIDEO        = f"cheetah_single_velocity_rollout_epoch{EPOCH}.mp4"
MAX_PATH_LENGTH  = 500
FPS              = 30
# ============================
...
def get_policy_and_env():
    ...
    # 创建 Ant 环境
    env = CheetahVelocityEnv(env_config, render_mode="rgb_array")
...
def rollout_and_render(env, policy, max_path_length=500, out_video="cheetah_velocity.mp4", fps=30):
