...
'''
import numpy as np
from third_party.CARE.bnpy.util import EPS
from third_party.CARE.bnpy.util import digamma, gammaln
from third_party.CARE.bnpy.util.NumericUtil import Config as PlatformConfig
from third_party.CARE.bnpy.util.NumericUtil import sumRtimesS
from third_party.CARE.bnpy.util.NumericUtil import inplaceLog
from third_party.CARE.bnpy.util import as2D

from third_party.CARE.bnpy.allocmodel.hmm.lib.LibFwdBwd import cppReady, FwdAlg_cpp, BwdAlg_cpp, SummaryAlg_cpp
