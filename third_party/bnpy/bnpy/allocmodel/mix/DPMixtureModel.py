...
from third_party.CARE.bnpy.util.StickBreakUtil import beta2rho
from third_party.CARE.bnpy.util.SparseRespUtil import sparsifyLogResp
from third_party.CARE.bnpy.util.SparseRespStatsUtil import calcSparseRlogR, calcSparseMergeRlogR
from third_party.CARE.bnpy.util.ShapeUtil import toCArray, as1D
ELBOTermDimMap = dict(
    Hresp='K',
)
