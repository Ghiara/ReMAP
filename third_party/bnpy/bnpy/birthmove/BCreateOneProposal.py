...
import os
import sys
import third_party.CARE.bnpy.init.FromTruth
from third_party.CARE.bnpy.birthmove import BLogger

from scipy.special import digamma, gammaln

from third_party.CARE.bnpy.allocmodel.topics.HDPTopicRestrictedLocalStep \
    import summarizeRestrictedLocalStep_HDPTopicModel

from third_party.CARE.bnpy.birthmove.BCleanup import cleanupMergeClusters, cleanupDeleteSmallClusters
from third_party.CARE.bnpy.birthmove.BirthProposalError import BirthProposalError
from third_party.CARE.bnpy.viz.PlotComps import plotCompsFromSS
from third_party.CARE.bnpy.viz.ProposalViz import plotELBOtermsForProposal
from third_party.CARE.bnpy.viz.ProposalViz import plotDocUsageForProposal
from third_party.CARE.bnpy.viz.ProposalViz import makeSingleProposalHTMLStr
from third_party.CARE.bnpy.viz.PrintTopics import vec2str

from third_party.CARE.bnpy.birthmove.BRestrictedLocalStep import \
    summarizeRestrictedLocalStep, \
    makeExpansionSSFromZ

from third_party.CARE.bnpy.init.FromScratchBregman import initSS_BregmanDiv
...
def createBirthProposalHTMLOutputDir(
    ...
    from third_party.CARE.bnpy.Run import deleteAllFilesFromDir
