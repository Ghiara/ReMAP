...
from third_party.CARE.bnpy.birthmove.zzzdeprecated.BRefinery import makeCandidateLPWithNewComps
from third_party.CARE.bnpy.birthmove.zzzdeprecated.BViz import showBirthBeforeAfter
import third_party.CARE.bnpy.birthmove.zzzdeprecated.BLogger as BLogger
...
def subsampleTargetFromDataAndLP(Data, model, LP, **Plan):
    ...
    * targetIDs
    ...
    if isinstance(Data, third_party.CARE.bnpy.data.BagOfWordsData):
        return _sample_target_BagOfWordsData(Data, model, LP, **Plan)
    elif isinstance(Data, third_party.CARE.bnpy.data.GroupXData):
    ...
    elif isinstance(Data, third_party.CARE.bnpy.data.XData):
        return _sample_target_XData(Data, model, LP, **Plan)
