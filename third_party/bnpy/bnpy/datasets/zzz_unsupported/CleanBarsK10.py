...
'''
import numpy as np
from third_party.CARE.bnpy.data import WordsData
import third_party.CARE.bnpy.datasets.zzz_unsupported.Bars2D as Bars2D
...
def showTrueTopics(pylab=None, block=False):
    import third_party.CARE.bnpy.viz.BarsViz as BarsViz
...
if __name__ == '__main__':
    from third_party.CARE.bnpy.callbacks import InferHeldoutTopics as IHT
