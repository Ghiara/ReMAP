...
import third_party.CARE.bnpy.deletemove as DLogger
from third_party.CARE.bnpy.ioutil.DataReader import loadDataFromSavedTask, loadLPKwargsFromDisk
from third_party.CARE.bnpy.ioutil.DataReader import loadKwargsFromDisk
from third_party.CARE.bnpy.ioutil.ModelReader import load_model_at_lap
...
def tryDeleteProposalForSpecificTarget_HDPTopicModel(
    ...
    from third_party.CARE.bnpy.allocmodel.topics.HDPTopicRestrictedLocalStep2 \
    ...
    if doPlotDocTopicCount:
        ...
        for d in docIDs:
            ...
            third_party.CARE.bnpy.viz.PlotComps.plotCompsFromHModel(
                curModel,
        ...
        third_party.CARE.bnpy.viz.BarsViz.showTopicsAsSquareImages(
            dIm,
            ncols=2,
            vmin=0,
            vmax=1,
    ...
    if doPlotComps:
        ...
        third_party.CARE.bnpy.viz.PlotComps.plotCompsFromSS(
                curModel,
                curSS,
                compsToHighlight=[ktarget],
                vmin=0,
