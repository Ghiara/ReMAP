...
"""
import numpy as np
import third_party.CARE.bnpy.deletemove.zzzdeprecated.DeleteLogger as DeleteLogger
from third_party.CARE.bnpy.deletemove.zzzdeprecated.DCollector import hasValidKey, getSize
...
def runDeleteMoveAndUpdateMemory(curModel, curSS, Plan,
    ...
    * acceptedIDs
    ...
    for delCompUID in Plan['candidateUIDs']:
        ...
        if doVizDelete:
            from third_party.CARE.bnpy.viz.PlotComps import plotCompsFromHModel
