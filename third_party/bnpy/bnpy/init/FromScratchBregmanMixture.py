...
from third_party.CARE.bnpy.util.OptimizerForPi import \
...
from third_party.CARE.bnpy.init.FromScratchBregman import makeDataSubsetByThresholdResp
...
if __name__ == '__main__':
    ...
    hmodel, Info = third_party.CARE.bnpy.run(Data, 'DPMixtureModel', 'Mult', 'memoVB',
