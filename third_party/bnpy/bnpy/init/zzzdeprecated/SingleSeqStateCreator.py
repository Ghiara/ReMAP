...
from third_party.CARE.bnpy.util.StateSeqUtil import calcContigBlocksFromZ

from third_party.CARE.bnpy.allocmodel.hmm.HDPHMMUtil import calcELBOForSingleSeq_FromLP
...
def showProposal(Data_n, LP_n, propResp, propLP_n,
    ...
    from third_party.CARE.bnpy.util.StateSeqUtil import alignEstimatedStateSeqToTruth
    from third_party.CARE.bnpy.util.StateSeqUtil import makeStateColorMap
