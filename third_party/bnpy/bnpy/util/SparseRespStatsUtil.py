...
from third_party.CARE.bnpy.util import dotATA
from third_party.CARE.bnpy.util.EntropyUtil import calcRlogR
from third_party.CARE.bnpy.util.ShapeUtil import as1D, toCArray

hasCPPLib = True
try:
    from third_party.CARE.bnpy.util.lib.sparseResp.LibSparseResp import (
    ...
    from third_party.CARE.bnpy.util.lib.sparseResp.LibSparseResp \
