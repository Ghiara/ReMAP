...
try:
    from third_party.CARE.bnpy.util.lib.sparseResp import LibSparseResp
    from third_party.CARE.bnpy.util.lib.sparseResp.LibSparseResp import sparsifyResp_cpp
    from third_party.CARE.bnpy.util.lib.sparseResp.LibSparseResp import sparsifyLogResp_cpp
    hasCPP = LibSparseResp.hasLibReady
except ImportError:
    hasCPP = False
