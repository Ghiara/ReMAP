...
class Walker2DChangingRandParamsEnv(RandomEnv, utils.EzPickle):
    def __init__(self, *args, **kwargs):
        ...
        RandomEnv.__init__(self, kwargs.get('log_scale_limit', 0), 'walker2d.xml', 5, observation_space, hfield_mode=kwargs.get('hfield_mode', 'gentle'), rand_params=kwargs.get('rand_params', []))
