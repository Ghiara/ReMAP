...
from third_party.rand_param_envs.rand_param_envs.gym import spaces
from third_party.rand_param_envs.rand_param_envs.gym.envs.box2d.car_dynamics import Car
from third_party.rand_param_envs.rand_param_envs.gym.utils import colorize

import pyglet
from pyglet import gl
from third_party.rand_param_envs.rand_param_envs.gym.utils import seeding
...
class CarRacing(gym.Env):
    ...
    def _render(self, mode='human', close=False):
        ...
        if self.viewer is None:
            from third_party.rand_param_envs.rand_param_envs.gym.envs.classic_control import rendering
