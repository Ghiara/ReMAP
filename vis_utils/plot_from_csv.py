...
csv_file_paths = dict(
    paths = ['/home/ubuntu/yuanmeng/bo/MRL-Inference-Reutilization/output/toy1d-multi-task/2025_12_07_15_08_34_default_true_gmm_timesteps_96/progress.csv'],
    names = ['No random']
)
column_name = 'train_eval_avg_reward_deterministic'
plot_name = 'toy_goal_MULTI_TASK_TIMESTEPS_96'
