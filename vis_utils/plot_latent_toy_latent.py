...
if __name__ == '__main__':
    ...
    for path in paths:
        main(path, *sys.argv[1:], hardcoded='/home/ubuntu/yuanmeng/bo/MRL-Inference-Reutilization/output/toy1d-multi-task/2026_01_06_20_48_55_default_single_gaussian_seed0_regular_loss_true_time_steps48/toy_test/logs/toy_latent_ep11')